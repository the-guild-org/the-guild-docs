...
import EmbeddedPage from './embedded.mdx'

# Getting Started - Guild Docs
...
<PackageCmd packages={['@guild-docs/client @guild-docs/server']} />
...
### Lorem ipsum dolorsitamet consectetura dipiscingelit.
...
Using backticks for headings. Useful for API examples.

##### Link color

- [Game Of Types: A Song Of GraphQL And TypeScript](https://formidable.com/blog/2019/strong-typing) - blog post.
