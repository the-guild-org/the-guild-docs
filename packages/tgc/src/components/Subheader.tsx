...
import { Container, Controls, CTA, Icon, Link, Logo, Navigation, Wrapper } from './Subheader.styles';
...
export const Subheader: React.FC<ISubheaderProps> = ({ product, activeLink, links, cta }) => {
  ...
  return (
    <>
      <Wrapper>
        <Container>
          <Logo href="/" onClick={product.onClick} title={`${product.title} - ${product.description}`}>
