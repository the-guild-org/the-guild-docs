...
export const Title = styled.h2(() => [tw`mt-0 mb-4 font-bold text-black dark:text-gray-50 text-2xl md:text-3xl`]);
...
export const Results = styled.div(() => [tw`flex flex-wrap xl:flex-nowrap -mx-6`]);
