...
export const Wrapper = styled.section(() => [tw`w-full bg-white dark:bg-gray-900`]);

export const Container = styled.div(() => [tw`container-max py-6`]);

export const Title = styled.h2(() => [tw`mt-0 mb-4 font-bold text-black dark:text-gray-50 text-xl md:text-2xl`]);
  ...
  css`
    td {
      ...
      button {
        ...
        img {
          ${[tw`w-5 m-0 ml-0.5 transform -rotate-90`, tw`transition duration-150 ease-in-out`]}
        }
      }
    }
  `,
