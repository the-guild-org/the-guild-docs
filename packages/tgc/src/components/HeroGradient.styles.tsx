...
export const Content = styled.div(({ hasImage }: IStyleProps) => [
  hasImage ? tw`mb-32 pt-8 pb-72 md:(mb-4 px-10 pt-24 pb-14)` : tw`pt-20 pb-20 md:(px-10 pt-24 pb-14)`,
]);
...
export const Image = styled.img(() => [tw`absolute w-full max-w-sm -bottom-36 -right-4 sm:(max-w-md) md:(-top-14 -right-16)`]);
