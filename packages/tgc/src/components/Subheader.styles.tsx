...
export const Container = styled.div(() => [tw`container-max flex justify-between md:justify-end`]);
...
export const Link = styled.a(({ isActiveLink }: IStyleProps) => [
  ...
  isActiveLink ? tw`text-black dark:text-white` : tw`text-gray-500 dark:text-gray-400`,
]);

export const Controls = styled.div(() => [tw`flex flex-none justify-end items-center`]);
